...
<Patch xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
  <PatchNumber>000</PatchNumber>
  <PatchDescription>000 - baseline, this is not a patch</PatchDescription>
...
# This is for app, don't forget to modify PatchNumber above with 001
...
Dir.glob("**/*").each do |file|
    ...
    #print "."
    web_line="<Script ScriptName=\"#{script_name}\" ScriptDate=\"\" ScriptNumber=\"\" ScriptRevision=\"0\" ScriptMinDBVersion=\"\" ScriptMaxDBVersion=\"\" ScriptIsRerunnable=\"0\" ScriptRequiredForBuild=\"\" ScriptDoNotRun=\"false\" FileType=\"WEB\" RelativePath=\"#{relative_path}\" BackObject=\"None\" BackObjectName=\"\" IsNew=\"false\" />\n"
    xml << web_line

end

#this is what it goes under the root directory
xml << '<Script ScriptName="Default.aspx" ScriptDate="" ScriptNumber="" ScriptRevision="0" ScriptMinDBVersion="" ScriptMaxDBVersion="" ScriptIsRerunnable="0" ScriptRequiredForBuild="" ScriptDoNotRun="false" FileType="WEB" RelativePath="\..\" BackObject="None" BackObjectName="" IsNew="false" />'
xml << end_file